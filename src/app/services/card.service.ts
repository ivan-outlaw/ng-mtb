...
export class CardService {
  ...
  cards: Card [] = [
    new Card('History', '/history', 'history', '../../../../assets/img/img-hystory.jpg', 'One of the first examples of bicycles modified specifically for off-road use is the expedition of Buffalo Soldiers from Missoula, Montana to Yellowstone in August 1896. The Swiss military had its first bike regiment in 1891.'),
